...
def main():
    ...
    flag = args.run_modelarts or args.run_openai
    config_ck = CheckpointConfig(save_checkpoint_steps=data.train_dataset.get_dataset_size(),
                                 keep_checkpoint_max=args.save_every if flag else args.keep_checkpoint_max)
    ...
    print(f"begin train {int(args.epochs - args.start_epoch + args.cooldown_epochs)} epochs")
